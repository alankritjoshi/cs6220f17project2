...
The main goal of this project is to identify and understand risk factors such as poor nutrition and physical inactivity and show their correlations to obesity. We will start from visualizing and analyzing the distribution of obesity, physical activity and nutrition conditions across United States using state-by-state data from 2011 to 2016. We will find the prevalence of overweight and obesity in United States and its trend. We will find the correlation of obesity with risk factors including poor nutrition, physical inactivity. We will also identify regions that share the same risk factors. Different socioeconomical, racial and ethnic groups will also be studied to learn more how inequalities contribute to higher obesity rates in certain communities.
...
We will start this analysis by performing heirachial clustering with a Euclidean distance metric so that we will be able to visualize and present the links between different regions through a dendrogram. 
